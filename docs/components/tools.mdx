...
MCP Tools enable executable operations on the database. DBHub provides SQL execution, token-efficient schema exploration, and database discovery capabilities.
