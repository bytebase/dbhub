---
title: "Quickstart"
description: "Get DBHub running in demo mode and connected to your AI tool in minutes"
---
...
v1.0.0 [DEMO] - Minimal Database MCP Server
...
Choose your AI tool and follow the setup instructions in the [Client Integration](/installation#client-integration) section. See the [HTTP Server](/config/http-server) guide for running DBHub as a shared network service, and [Authentication](/config/auth-token) for securing it with bearer tokens.
