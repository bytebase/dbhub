...
By default, DBHub attempts to install drivers for all supported databases (PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, Redis). If you only need specific databases, you can skip the unnecessary drivers to reduce installation size.
