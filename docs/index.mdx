...
Explore and execute database tools through the built-in workbench:
- View all configured data sources
- Track recent SQL requests

![DBHub Workbench](https://raw.githubusercontent.com/bytebase/dbhub/main/docs/images/workbench.webp)
