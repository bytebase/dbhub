---
title: "Introduction"
description: "Universal Database MCP Server implementing the Model Context Protocol"
---
...
DBHub is a Universal Database MCP Server that implements the Model Context Protocol (MCP) server interface. It enables AI-powered tools like Claude Desktop, Claude Code, Cursor, and VS Code Copilot to securely connect to and interact with your databases.
