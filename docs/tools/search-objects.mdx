...
<CodeGroup>
```json Search for functions starting with "get"
{
  "object_type": "function",
  "pattern": "get%",
  "detail_level": "summary"
...
```json Get full function details
{
  "object_type": "function",
  "pattern": "add_numbers",
  "detail_level": "full"
...
// Returns complete function definition including parameters and body
```

```json List all functions in a schema
{
  "object_type": "function",
  "schema": "public",
  "detail_level": "names"
