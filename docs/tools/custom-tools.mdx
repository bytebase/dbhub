...
Custom tools are defined in your `dbhub.toml` configuration file. See the [Tool Options](/config/server-options#tool-options) documentation for complete configuration reference.
...
See [Tool Options Configuration](/config/server-options#statement) for detailed field descriptions, parameter types, and validation rules.
...
See [Parameter Placeholders](/config/server-options#parameters) for syntax reference.
...
- [Tool Options Configuration](/config/server-options#tool-options) - Complete configuration reference
